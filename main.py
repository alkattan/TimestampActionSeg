...
# Setup the device for PyTorch (use CUDA if available)
...
sample_rate = 1
# Adjust the sample rate for the 50salads dataset
if args.dataset == "50salads":
    sample_rate = 2

# Define paths for video lists, features and ground truths
...
# Setup output directories with time data for distinguishing different trainings
...
# Read the action mapping file and create a dictionary of actions
...
# Initialize the TensorBoard writer and the model Trainer
writer = SummaryWriter()
trainer = Trainer(num_stages, num_layers, num_f_maps, features_dim, num_classes)

# If action is "train", train the model
